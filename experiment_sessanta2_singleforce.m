...
%% run_task (optimized for zero-lag streaming)
...
% Throttle display refresh independently of acquisition loop
render_interval = 0.033; % ~30 FPS limit for smooth graphics without choking CPU
t_render = tic;
col = 1;
...
for k = 1:n_steps
    ...
    % Only update plot graphics throttled to prevent UI event queue backup
