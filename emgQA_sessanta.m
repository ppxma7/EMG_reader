%% emg_qa_viewer_single_channel.m
% Fast live EMG trace viewer for a SINGLE electrode — quick "is it recording"
% check before running experiment_sessanta1_singleforce.m.
...
% CONFIG
% =========================================================================
ch_to_test = 1;    % <-- change this to whichever EMG channel (1-64) you want to check
...
% =========================================================================
% CONNECT (Sessantaquattro+ connects to us — we're the TCP server)
% =========================================================================
...
fprintf('Connected. Checking channel %d...\n', ch_to_test);
fprintf('  Q = quit\n\n');
